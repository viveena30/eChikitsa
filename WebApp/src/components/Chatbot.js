...
const steps = [
    {
        id: "1",
        message: "Hey! I am Chiki a bot, how are you feeling today",
        trigger: "expressions",
    },
    {
        id: "expressions",
    ...
    },
    {
        ...
        options: [
            ...
            { value: "Appointment", label: "Appointment", trigger: "selectedService" },
            { value: "Records", label: "Records", trigger: "selectedService" },
